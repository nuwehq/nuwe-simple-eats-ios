             ...
             for (int i = 0; i < count ; i++)
             {
                 ...
                 if (arraySubGroup != (NSArray*)[NSNull null])
                 {
                     ...
                     for (NSDictionary* dict in arraySubGroup)
                     {
                         ...
                         subGroup.nSmallDefaultPortion = [[dict objectForKey: @"small_portion"] integerValue];
                         subGroup.nMediumDefaulPortion = [[dict objectForKey: @"medium_portion"] integerValue];
                         subGroup.nLargeDefaulPortion = [[dict objectForKey: @"large_portion"] integerValue];
...
//    NSString* strToken = [NSString stringWithFormat:@"Token %@", gData.meInfo.szTokenApi];
    ...
    int nCount = [gData.aIngredientSubGroups count];
